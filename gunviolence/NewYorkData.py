...
class NewYorkData():
	def __init__(self, *args):
		...
		self.df.rename(columns={'PREM_TYP_DESC': 'Location Description', 'Lat_Lon': 'Location', 'BORO_NM': 'DIST_NUM', 'OFNS_DESC': 'Primary Type', 'PD_DESC': 'Description'})
		self.meta = dict()
		self.args = args
	...
	def pull_data(self):
		os.system("curl 'https://data.cityofnewyork.us/api/views/qgea-i56i/rows.csv?accessType=DOWNLOAD' -o '%NYPD_Complaint_Data_Historic.csv'" % self.DATA_PATH)
		...
		os.system("cat '{0}NYPD_Complaint_Data_Historic.csv' {0}NYPD_Complaint_Data_Current_YTD.csv > NYPD_Complaint_data.csv" .format(self.DATA_PATH))
		return self
	...
	def pull_metadata(self):
		# 5 Boros: http://services5.arcgis.com/GfwWNkhOj9bNBqoJ/arcgis/rest/services/nynta/FeatureServer/0/query?where=1=1&outFields=*&outSR=4326&f=geojson
		# Brooklyn http://catalog.civicdashboards.com/dataset/bcdd8479-5881-40bd-90fd-7320aa1673d7/resource/7a0a136e-b7bb-44f5-8044-f21591ef49aa/download/77dc2ff50622407695f954d8e77c3317brooklynneighborhoodspolygon.geojson		
		os.sysmte("curl 'https://data.cityofnewyork.us/api/views/kmub-vria/rows.csv?accessType=DOWNLOAD' -0 '%sprecinct.csv" % self.DATA_PATH)
